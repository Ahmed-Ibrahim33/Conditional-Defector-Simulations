  ...
  ask n-of Number-Agents patches [
    sprout 1 [
      ...
      ifelse harvestPref = "high" [
        set escaper? true   ;; الغشاش دايمًا هارب
      ] [
        set escaper? false
      ]
...
to escape-behavior
  ask turtles with [ harvestPref = "high" and escaper? ] [
    if energy > Costs-escape [
      let potential-punishers (turtles-on neighbors) with [ punisher? ]
...
"Greedy,escaper " 1.0 0 -2674135 true "" "plotxy ticks ( count turtles with [color = red] / count turtles) * 100"
...
"Greedy, escaperr" 1.0 0 -2674135 true "" "carefully [plot sum [energy] of turtles with [color = red ] / count turtles with [color = red ]][plot 0]"
...
"Greedy, escaper" 1.0 0 -2674135 true "" "carefully [plot sum [harvest] of turtles with [color = red] / count turtles with [color = red]][plot 0]"
